...
{
    public class CreateArticleValidator<T> : CustomValidator<T>
        where T : NewArticle
    {
        private readonly IArticleRepository articleRepo;

        public CreateArticleValidator(IArticleRepository articleRepo)
        {
        ...
        protected override void Validations(T obj, ValidationErrorCollection errors)
        {
            ...
            {
                if (articleRepo.ExistArticle(obj.Url))
